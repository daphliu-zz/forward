...
var drawingApp = (function() {
  ...
  var canvas,
      ...
      var press = function(e) {
          ...
          if (mouseX < drawingAreaX) {
            ...
            if (mouseX > mediumStartX) {
              if (
                mouseY > mediumStartY &&
                mouseY < mediumStartY + mediumImageHeight
              ) {
            ...
            if (mouseY > toolHotspotStartY) {
              if (mouseY > sizeHotspotStartY) {
                ...
                if (
                  mouseY < sizeHotspotStartY + sizeHotspotHeight &&
                  mouseX > sizeHotspotStartX
                ) {
                  if (
                    mouseX <
                    sizeHotspotStartX + sizeHotspotWidthObject.huge
                  ) {
                    curSize = "huge";
                  } else if (
                    mouseX <
                    sizeHotspotStartX +
                      sizeHotspotWidthObject.large +
    ...
    init = function() {
      ...
      outlineImage.src = "images/human.png";
    };
